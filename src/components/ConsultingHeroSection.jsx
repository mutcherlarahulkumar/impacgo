...
import bgimg from '../assets/financialimg.jpg';
import { ChevronDown } from 'lucide-react';

function ConsultingHeroSection() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <img
        src={bgimg}
        alt="Consulting & Digital Transformation"
      ...
      >
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl">
          Strategic technology advisory — process redesign, ERP/MES readiness,
          change management, training, and end-to-end digital transformation
          journeys backed by 19+ years of domain expertise.
        </p>
