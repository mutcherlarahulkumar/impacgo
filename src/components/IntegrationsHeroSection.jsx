...
import bgimg from '../assets/supplychain.jpg';
import { ChevronDown } from 'lucide-react';

function IntegrationsHeroSection() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl">
          We connect ERP, MES, CRM, e-commerce, and third-party platforms with
          secure, real-time integrations built to scale — bridging legacy
          systems and modern cloud platforms seamlessly.
        </p>
