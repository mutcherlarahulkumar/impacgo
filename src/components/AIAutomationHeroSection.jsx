...
function AIAutomationHeroSection() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      >
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl">
          ...
          business — from RPA and AI chatbots to computer vision, predictive
          analytics, and AI-powered decision support embedded into your ERP
          systems.
        </p>
...
export default AIAutomationHeroSection;