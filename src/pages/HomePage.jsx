...
function HeroSection() {
  const services = ['Point of Sale', 'Microsoft Dynamics 365'];
...
function IndustriesSection() {
  const industries = ['Retail', 'Supply Chain', 'Manufacturing'];
  const imgIndustries = [retail, supplyChain, manufacturingImage];
