...
function DairyFarmHeroSection() {
  return (
    ...
    >
      ...
      >
        <span className="bg-green-600 text-white text-xs font-semibold px-4 py-1.5 rounded-full mb-6 tracking-widest">
          IMPACGO PRODUCT
        </span>
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl">
          ...
          production tracking, herd health, breeding, feed management,
          finance, and KPI dashboards in one purpose-built platform.
        </p>
...
export default DairyFarmHeroSection;