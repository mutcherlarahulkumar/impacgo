    ...
    >
      ...
      >
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl">
          A complete, open source ERP platform purpose-built for small and
          mid-market businesses — accounting, CRM, inventory, HR, projects,
          and e-commerce in one system. Implemented right by Impacgo.
        </p>
...
export default ERPNextHeroSection;