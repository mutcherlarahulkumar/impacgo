...
import bgimg from '../assets/manufacturing.jpg';
import { ChevronDown } from 'lucide-react';

function MESHeroSection() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <img
        src={bgimg}
        alt="Manufacturing Execution Systems"
      ...
      >
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl">
          Connect your shop floor to the top floor with real-time production
          visibility, OEE tracking, quality control, and closed-loop ERP
          integration — built for modern manufacturers.
        </p>
