...
function WorkTaskHeroSection() {
  return (
    ...
    >
      ...
      >
        <span className="bg-blue-600 text-white text-xs font-semibold px-4 py-1.5 rounded-full mb-6 tracking-widest">
          IMPACGO PRODUCT
        </span>
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl">
          Project-based time tracking for consultants and employees — manage
          projects, tasks, daily timesheets, consultant utilisation, and
          approval workflows in one streamlined application.
        </p>
...
export default WorkTaskHeroSection;